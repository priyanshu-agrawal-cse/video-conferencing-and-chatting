...
//       if (videoPermision || audioPermision) {
//         let userMediaStream = await navigator.mediaDevices.getUserMedia({ audio: AudioAvailable, video: videoAvailable });
//         if (userMediaStream) {
...
//         console.log(error)
//       }
//       let blackSilece = (...args) => new MediaStream([black(...args), silence()]);
//       window.localStream = blackSilece();
...
//     let oscillator = cxt.createOscillator();
//     let dst = oscillator.connect(cxt.createMediaStreamDestination());
//     oscillator.start()
//     cxt.resume()
...
//   let addMessage = (data, sender , socketIdSenedr) => {
//     setMessages((preMessages)=>[
//       ...preMessages ,
//       {sender : sender , data : data}
//     ]);
//     if(socketIdSenedr != socketIdRef.current){
...
//             let videoExist = videoRef.current.find(videeo => videeo.socketId == socketListId);
//             if (videoExist) {
//               setVideos(videos => {
...
//       {askForUsername === true ? <div> <h3>enter into lobby</h3>
...
//                 return(
//                 <div style={{marginBottom :"1.2rem"}} key={index}>
...
//           {ScreenAvailable === true ? <IconButton onClick={handelScreen} style={{ color: "white" }}>
